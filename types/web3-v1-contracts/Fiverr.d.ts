...
export interface Fiverr extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  clone(): Fiverr;
  methods: {
    membership(arg0: string): NonPayableTransactionObject<string>;
    ...
    setCostOfMemmbership(
      _days: number | string | BN,
      _amount: number | string | BN
    ): NonPayableTransactionObject<void>;

    getCostOfMemmbership(
      _days: number | string | BN
    ): NonPayableTransactionObject<string>;

    getCurrentTime(): NonPayableTransactionObject<string>;

    getSingleMinuteMembership(): PayableTransactionObject<void>;

    getSingleDayMembership(): PayableTransactionObject<void>;

    getSevenDayMembership(): PayableTransactionObject<void>;

    getOneMonthMembership(): PayableTransactionObject<void>;

    getSixMonthMembership(): PayableTransactionObject<void>;

    isWhitelisted(_address: string): NonPayableTransactionObject<boolean>;

    isMember(_address: string): NonPayableTransactionObject<boolean>;

    whitelistedPeriod(_address: string): NonPayableTransactionObject<string>;
    ...
    blacklistUsers(_users: string[]): NonPayableTransactionObject<void>;

    listOfwhitelistedUsers(): NonPayableTransactionObject<string[]>;

    totalBalanceAvailable(): NonPayableTransactionObject<string>;
